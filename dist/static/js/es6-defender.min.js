...
var Event = Object.freeze({ locked: 1, abducted: 2, mutated: 3, dead: 4, removeProjectile: 5, removeHuman: 6, playerDead: 7, collectedHuman: 8 });

var easing = 0.05;
var playerAccelX = 0.3;
var playerDampingX = 0.1;
var playerMaxSpeedX = 3.0;
var playerMaxSpeedY = 1.0;
var modulusx = 512;
...
var Star = function (_StateVector5) {
  _inherits(Star, _StateVector5);

  function Star(id, x, y, depth) {
    _classCallCheck(this, Star);

    var _this5 = _possibleConstructorReturn(this, (Star.__proto__ || Object.getPrototypeOf(Star)).call(this, id, x, y));
...
var invaders = fillWith(10, function (_) {
  return new Invader(invaderId++, (Math.random() - 0.5) * modulusx, 96 / 2, InvaderState.seeking, 0);
});
var humanId = 200;
...
var doGame = function doGame(fastTextMode, viewWidth, viewHeight, input, t) {
  ...
  var allEvents = [].concat(projectileEvents, playerProjectileHitEvent, playerInvaderHitEvent, playerHumanHitEvent, invaderEvents);
