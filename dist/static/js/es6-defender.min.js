...
var Event = Object.freeze({ locked: 1, abducted: 2, mutated: 3, dead: 4, removeProjectile: 5, removeHuman: 6 });
...
var doGame = function doGame(fastTextMode, viewWidth, viewHeight, input) {
  ...
  var invaderEvents = [].concat(hitEvents, seekingInvaderEvents, lockedInvaderEvents);

  var allEvents = [].concat(projectileEvents, hitEvents, invaderEvents);
