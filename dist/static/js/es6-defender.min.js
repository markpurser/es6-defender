...
var easing = 0.05;
var playerAccelX = 720;
var playerDampingX = 6;
var playerMaxSpeedX = 114;
...
var updateInvaders = function updateInvaders(invaders, invaderTargets, player, dt) {
...
var updateHumans = function updateHumans(humans, dt) {
...
var updateProjectiles = function updateProjectiles(projectiles, dt) {
...
var updateDebris = function updateDebris(debris, dt) {
...
var humans = fillWith(10, function (_) {
  return new Human(humanId++, (Math.random() - 0.5) * modulusx, 94, 12 * (Math.random() - 0.5));
});
...
var doGame = function doGame(fastTextMode, viewWidth, viewHeight, input, sound, t, dt) {
