...
// -------------------------------------------------------------------------------------------------------------------------------------------
var doGame = function doGame(textivision, input, sound, t, dt) {
  ...
  allEvents.filter(function (e) {
    ...
    sound('death');player.state = PlayerState.exploding;
  });
  allEvents.filter(function (e) {
...
var TextIVision = function () {
    function TextIVision() {
        _classCallCheck(this, TextIVision);
    }

    _createClass(TextIVision, [{
        key: 'init',
